export const voyageData = [
  ...
  },
  {
    ...
    description:
      "L'ascension de l'Everest s'entreprend essentiellement au printemps, avant la mousson, mais ne laissez pas la météo vous décourager. Passez un Nouvel An inoubliable sur les sommets de la montagne emblématique. Revivez l'aventure du film Everest et faites des photos sur les lieux du tournage du film.",
    age_recommended: "+70",
    name_guide: "Luna Lovegood",
  ...
  },
  {
    ...
    description:
      "Des millions de fidèles trouvent le salut en se baignant dans les flots de Gange et en buvant son eau. Ce fleuve sacré contient les pires poisons : métaux lourds, matières fécales et produits chimiques intoxiquent lentement mais sûrement ses pèlerins.",
    age_recommended: "18-70",
    name_guide: "Luna Lovegood",
  ...
  {
    id_activity: 8,
    name_activity: "Marcher sur la piste cyclable à Amsterdam",
    description:
  ...
  },
  {
    ...
    description:
      "Combinez les activités les plus emblématiques de la région : tequila et rodeo. Parfait pour un enterrement de vie de garçon.",
    age_recommended: "18-70",
    name_guide: "Phoebe Buffay",
  ...
  },
  {
    ...
    description:
      "Le Canyon de Nazaré provoque de grosses vagues, faisant de Nazaré un spot incontournable dans le monde du surf. Actuel détenteur du record du monde de la plus grosse vague surfée avec une hauteur d’un peu plus de 24 mètres à Nazaré en 2017 est Rodrigo Koxa.",
    age_recommended: "18-70",
    name_guide: "Jim Carrey",
  ...
  },
  {
    ...
    description:
      "Vous vous sentez un peu seul(e) ? Venez faire de nouvelles rencontres dans une ambiance conviviale et décontractée.",
    age_recommended: "18-70",
    name_guide: "Jim Carrey",
